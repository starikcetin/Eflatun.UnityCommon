...
public sealed class PrefabPool
{
    ...
    /// <param name="prePopulate">Populates pool with given amount instantly.</param>
    ...
    /// </summary>
    private void NotifySpawn(GameObject spawned)
    {
    ...
    /// </summary>
    private void NotifyDespawn(GameObject despawned)
    {
